...
export const getPreviewContent = (content: string | null) => {
  ...
  const stableScripts = `
    ...
    <script src="https://npm.elemecdn.com/prop-types@15.8.1/prop-types.min.js"></script>
    <script src="https://npm.elemecdn.com/@babel/standalone@7.23.5/babel.min.js"></script>
    <script src="https://npm.elemecdn.com/lucide-react@0.263.1/dist/umd/lucide-react.min.js"></script>
    <script src="https://npm.elemecdn.com/recharts@2.12.0/umd/Recharts.min.js"></script>
    <script>
