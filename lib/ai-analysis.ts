...
export async function analyzeTitle(htmlContent: string) {
...
export async function analyzeDescription(htmlContent: string) {
...
export async function analyzePrompt(htmlContent: string) {
